...
const CommunityTabPage: React.FC = () => {
    ...
    <div className="flex items-center space-x-2">
      ...
      <div className="relative">
        <input
          type="text"
          placeholder="Search..."
          className="pl-8 pr-3 py-2 rounded-full text-sm border border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white"
        />
  ...
  return (
    <div className="pb-20 bg-gray-50 dark:bg-gray-900 min-h-screen">
      <PageHeader title="Community" rightContent={headerRightContent} />
      ...
      <div className="max-w-lg mx-auto px-4 py-4">
        ...
        {isFilterVisible && (
          <motion.div 
            ...
            className="bg-white dark:bg-gray-800 rounded-lg shadow-sm dark:border dark:border-gray-700 p-3 mb-6"
          >
